...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .row.justify-content-center.align-items-center.mb-2(data-aos="zoom-in")
      .col-lg-12
        .bloque-texto-g.bloque-texto-g.p-3.p-sm-4.p-md-5.bg-04
          .bloque-texto-g__img(
            :style="{'background-image': `url(${require('@/assets/curso/temas/tema4/img_01.png')})`}"
          )
          .bloque-texto-g__texto.p-4.bg-transparent
            p Una estrategia es un plan de acción cuidadosamente diseñado para alcanzar un objetivo determinado. Las estrategias no son improvisaciones; son el resultado del análisis, la experiencia y la planificación enfocada en lograr resultados sostenibles.
    ...
    .row.justify-content-center.align-items-center.mb-2(data-aos="zoom-in")
      ...
      .col-lg-2.col-md-5.mb-4
        figure
          img(src='@/assets/curso/temas/tema4/img_03.png', alt='Imagen decorativa')
    ...
    .row.justify-content-center.align-items-center.mb-2(data-aos="zoom-in")
      .col-lg-3.col-md-8.mb-4
        figure
          img(src='@/assets/curso/temas/tema4/img_04.png', alt='Imagen decorativa')
      .col-lg-9.mb-4
